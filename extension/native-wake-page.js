  ...
  async function wakeCompanion() {
    ...
    wakePromise = (async () => {
      try {
        ...
        // Unpacked development builds may not yet be in the native host's
        // explicit allowed_origins list. The normal reconnect layer remains
        // available as a graceful fallback.
